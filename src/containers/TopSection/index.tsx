...
import BackgroundImage from "../../images/Nusa-Penida-Bali.jpg";
...
const LandingSection = styled.div`
    ...
    background-image: url( ${BackgroundImage} ), 
                      linear-gradient(to right, #007f9c, #b1d1b148);
...
export function TopSection() {
    ...
    <TopSectionContainer name="Home">
        <LandingSection>
         <NavBar />
         <InfoSection>
          <FloatingText>LAND</FloatingText>
          <FloatingText style={{ display: "inline-flex" }}>
            OF
            <OutlinedTextSvg viewBox="0 0 700 100">
              <text>BEAUTY,</text>
            </OutlinedTextSvg>
          </FloatingText>
          <FloatingText>INDONESIA.</FloatingText>
          <DescriptionText>
            Explore the worlds largest island country and all its wonders - Indonesia. 
            Enjoy 3 vacation packages at competitive prices.
          </DescriptionText>
        </InfoSection>
        <ViewMoreButton>
